...
<form action="<?php echo base_url()?>user/login/onsite" method="post" id="login" name="login">
...
<form action="<?php echo base_url()?>user/registration/social_registration/CreateSocialAccount" method="post" id="login" name="login">
