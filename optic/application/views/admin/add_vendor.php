...
<div class="container">
    ...
    <div class="right_div">
        ...
        <div class="clear"></div>
        <form id="frm_vendor" name="frm_vendor" method="post" action="<?php echo base_url();?>admin/vendor/insert" >
            ...
            <div class="label_input">
                ...
                <div class="input">
                    <select class="input" id="vendorfor" name="vendorfor" style="margin: 5px 0 0;width: 138px;">
                        ...
                        <option value="<?php echo $product_type->fld_id;?>"><?php echo $product_type->fld_name;?></option>
                        <?php endforeach;?>
                    </select>
                </div>
            </div>
            ...
            <div class="label_input">
                ...
                <div class="input"><input type="text" name="mobile"></div>
            </div>
            <div class="clear"></div>
            <div class="label_input">
