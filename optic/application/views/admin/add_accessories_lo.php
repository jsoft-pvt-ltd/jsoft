...
?><input type ="hidden" name="attr_id[]" id="attr_id[]" value="<?php echo $attr->fld_id;?>" />
                ...
                <div class="clear_left label">&nbsp;</div>
                    ...
                    <div class="_input" style="display: inline-block;">Quantity<br/><input type="text" onblur="set_qty();" value="<?php echo $attr->fld_qty;?>" name="qty_color_old[]" id="qty_color[]" maxlength="7"/></div>
                    ...
                    </div><a href="javascript:void(0);" class="add_attribute_values" onclick="add_color(this.name);"  name="values_<?php echo $count;?>">[+]</a>&nbsp;&nbsp;
                ...
                <div class="clear_left label">&nbsp;</div>
                    ...
                    <div class="_input" style="display: inline-block;">Quantity<br/><input type="text" onblur="set_qty();" value="<?php echo $qty;?>" name="qty_color_new[]" id="qty_color[]" maxlength="7"/></div>
                    <div class="_input" style="display: inline-block;"><br/>
...
function add_color()
{
    ...
    var html = '<div id="values_'+count+'">'+
                    ...
                    '<div class="_input" style="display: inline-block;">Quantity<br/><input type="text" value="" name="qty_color_new[]" id="qty_color[]"onblur="set_qty();" maxlength="7"/></div>  '+
                    '<div class="_input" style="display: inline-block;"><br/>'+
...
{
    var sum = 0;
    $('input[id^="qty_color"]').each(function(){
