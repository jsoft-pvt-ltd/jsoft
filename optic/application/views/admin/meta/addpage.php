...
<div class="container">
    ...
    <div class="right_div">
        <div>
            <form action="<?php echo base_url().'admin/dynamic/insert_page'; ?>" method="post" name="frm" id="frm" enctype="multipart/form-data">
                <div id="sub_" class="label" style="float:left; margin-bottom: 5px;">
                    Page Name:
                </div>
                <input type="text" name="page" id="page" class="input"><br>
                Page Content:<br><textarea name="content" id="content"></textarea>
