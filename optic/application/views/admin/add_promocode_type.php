<div class="container">
    ...
    <div class="right_div">
        ...
        <form id="frm_product_type" name="frm_product_type" method="post" action="<?php echo base_url();?>admin/promocode/add_promocode_type">
            <table width="100%">
                <tr><td>Promocode Type : </td><tr>
                <tr><td><textarea name="promocode_type" rows="1" cols="95"></textarea></td></tr>
