...
<div class="container">
    ...
    <div class="right_div">
        ...
        <div class="clear"></div>
        <form id="frm_carrier" name="frm_carrier" method="post" action="<?php echo base_url();?>admin/carrier/insert" >
            <div>Please fill the form</div>
            <div class="clear"></div>
            <div class="label_input">
                <div class="label">Country</div>
                <div class="input">
                    <select class="input" id="fld_country" name="country" style="margin: 5px 0 0;width: 138px;"> 
                        <?php foreach($countries->result() as $country):?>
                            <option value="<?php echo $country->fld_id;?>"><?php echo $country->fld_name;?></option>
                        <?php endforeach;?>
                    </select>
                </div>
            </div>
            ...
            <div class="label_input">
                ...
                <div class="input"><input type="text" name="carrier"></div>
            </div>
            <div class="clear"></div>
            <div class="label_input">
                <div class="label">Shipping Cost</div>
                <div class="input"><input type="text" name="shipping_cost"></div>
            </div>
            <div class="clear"></div>
            <div class="label_input">
                <div class="label">Additional Cost</div>
                <div class="input"><input type="text" name="additional_cost"></div>
            </div>
            <div class="clear"></div>
            <div class="label_input">
                <div class="label">Insurance Cost</div>
                <div class="input"><input type="text" name="insurance_cost"></div>
            </div>
            <div class="clear"></div>
            <div class="label_input">
                <div class="label">Additional Insurance Cost</div>
                <div class="input"><input type="text" name="additional_insurance_cost"></div>
            </div>
            <div class="clear"></div>
            <div class="label_input">
                <div class="label">&nbsp;</div>
