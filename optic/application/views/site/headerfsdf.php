                                ...
                                <li class="title">
                                    ...
                                    <div class="sub_menu_holder search_menu">
                                        <?php $this->load->helper('search_helper');$product_types = product_types();
                                            $ucat=array();//$cats = get_attributes();echo '<pre>';print_r($cats);echo '<pre>';exit;
                                        ?>
                                            <div class="sub_menu">
                                              =======================================================================================
                                                <div id="adv2"> 
                                                    <div id="usual_header" class="usual_header"> 
                                                        ...
                                                        <?php $count_tab=1;foreach($product_types->result() as $product_type):?>
                                                            ...
                                                            <div id="tab<?php echo $count_tab;?>" class="tabs">
                                                                ...
                                                                <div class="catsh">
                                                                    <?php $this->load->helper('search_helper');$categories = categories($product_type->fld_id);?>
...
<!--/*:::::::::::::::::::::::::::::::::::::::::::::::::::price range slider:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::*/-->                  
                                                                    ...
                                                                    <div>Price Range 
<!--                                                <p><input type="text" id="amount" style="border: 0; color: #333333;background: none; font-weight: bold;"></p>-->
